...
```
feat: add server crud endpoints (create, list, join, leave)
```
...
```
feat: build 3-panel discord-like layout shell
```
...
```
feat: render message history and live messages in chat window
```
